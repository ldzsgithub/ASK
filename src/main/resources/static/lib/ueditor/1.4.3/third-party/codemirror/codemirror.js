...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        // can be kept css when scrolling.
        ...
        var instance = wrapper.CodeMirror = {
            ...
            // Stuff used by commands, probably not much user to outside code.
    ...
    var commands = CodeMirror.commands = {
        ...
        goCharLeft: function(cm) {cm.moveH(-1, "chart");},
        goCharRight: function(cm) {cm.moveH(1, "chart");},
        goColumnLeft: function(cm) {cm.moveH(-1, "column");},
        goColumnRight: function(cm) {cm.moveH(1, "column");},
        goWordLeft: function(cm) {cm.moveH(-1, "word");},
        goWordRight: function(cm) {cm.moveH(1, "word");},
        delCharLeft: function(cm) {cm.deleteH(-1, "chart");},
        delCharRight: function(cm) {cm.deleteH(1, "chart");},
