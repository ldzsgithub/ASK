 ...
 * CSV, HTML tables or grid views into basic configuration options for user
 ...
 * 
 * - endColumn : Integer
 * In tabular input data, the first row (indexed by 0) to user. Defaults to the last
 * column containing data.
 *
 * - endRow : Integer
 * In tabular input data, the last row (indexed by 0) to user. Defaults to the last row
 * containing data.
 *
 ...
 *
 * - startColumn : Integer
 * In tabular input data, the first column (indexed by 0) to user.
 *
 * - startRow : Integer
 * In tabular input data, the first row (indexed by 0) to user.
 *
