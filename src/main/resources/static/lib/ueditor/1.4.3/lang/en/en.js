...
UE.I18N['en'] = {
    ...
    'contextMenu':{
        ...
        'copy':"Copy(Ctrl + c)",
        'copymsg':"Browser does not support. Please user 'Ctrl + c' instead!",
        'paste':"Paste(Ctrl + v)",
        'pastemsg':"Browser does not support. Please user 'Ctrl + v' instead!"
    },
    'copymsg': "Browser does not support. Please user 'Ctrl + c' instead!",
    'pastemsg': "Browser does not support. Please user 'Ctrl + v' instead!",
    'anthorMsg':"Link",
    ...
    help:{
        'static':{
            ...
            'lang_input_introduction':"UEditor is developed by Baidu Co.ltd.  It is lightweight, customizable , focusing on user experience and etc. , UEditor is based on open source BSD license , allowing free user and redistribution.",
