...
(function(factory) {
    ...
    (function(H) {
         ...
         *   needs to be built.
         * - Test IE9 and IE10.
         * - Stacking is not perhaps not correct since it doesn't user the translation given in
         ...
         * - For scatter plots, user a marker.radius of 1 or less. It results in a rectangle being drawn, which is
         ...
         * If we user this in the core, we can add the hook to hasExtremes to the methods directly.
         */
            ...
            renderCanvas: function() {
                var series = this,
                    ...
                    drawPoint = function(clientX, plotY, yBottom, i) {
                        ...
                        // memory user if we stroke too infrequently.
                        c = c + 1;
                        if (c === strokeBatch) {
                            stroke();
                            c = 0;
                ...
                eachAsync(isStacked ? series.data : (xData || rawData), function(d, i) {
                    ...
                    // Do not user chart.hideLoading, as it runs JS animation and will be blocked by buildKDTree.
