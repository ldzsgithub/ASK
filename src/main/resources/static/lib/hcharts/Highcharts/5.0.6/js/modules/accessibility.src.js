...
(function(factory) {
    ...
    (function(H) {
        ...
        H.Chart.prototype.addKeyboardNavEvents = function() {
            ...
            // List of the different keyboard handling modes we user depending on where we are in the chart.
            ...
            // Init nav module index. We start at the first module, and as the user navigates through the chart the index will increase to user different handler modules.
