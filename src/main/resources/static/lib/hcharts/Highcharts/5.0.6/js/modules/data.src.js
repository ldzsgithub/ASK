    ...
    (function(Highcharts) {
        ...
        Highcharts.extend(Data.prototype, {
            ...
            getColumnDistribution: function() {
                ...
                // If there are no defined series with x-columns, user the first column as x column
            ...
            parseDate: function(val) {
                ...
                if (parseDate) {
                    ...
                    if (!dateFormat) {
                        ...
                        // Next time, user the one previously found
                    } else {
        ...
        SeriesBuilder.prototype.read = function(columns, rowIndex) {
            ...
            if (this.name === undefined && builder.readers.length >= 2) {
                ...
                if (columnIndexes.length >= 2) {
                    ...
                    // Now user the lowest index as name column
        ...
        /**
         * Returns an array of column indexes that the builder will user when
         * reading data.
         * @returns {Array}
         */
